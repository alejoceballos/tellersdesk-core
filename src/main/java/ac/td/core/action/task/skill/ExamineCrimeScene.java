...
public class ExamineCrimeScene extends SkillTask {

    public ExamineCrimeScene(final SkillfulCharacter character, final DieFactory dieFactory)
            throws TaskCharacterException, TaskDieFactoryException {
        super(character, dieFactory);
    }

    public ExamineCrimeScene(
