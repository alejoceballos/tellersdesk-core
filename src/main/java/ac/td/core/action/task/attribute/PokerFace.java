...
public class PokerFace extends AttributeTask {

    public PokerFace(SkillfulCharacter character, DieFactory dieFactory)
    ...
    public Set<AttributeType> getDrivingAttributes() {
        return Set.of(AttributeType.MANIPULATION, AttributeType.COMPOSURE);
    }
